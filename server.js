...
const serve = (localpath, cache) => express.static(resolve(localpath), {
  maxAge: cache && isProd ? 60 * 60 * 24 * 30 : 0,
});

app.use(compression({ threshold: 0 }));
app.use(favicon('./static/ui/Index-Beasiswa-Logo-Icon.png'));
...
app.listen(port, '0.0.0.0', () => {
  console.log(`server started at 0.0.0.0:${port}`); // eslint-disable-line
});
